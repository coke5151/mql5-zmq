...
//+------------------------------------------------------------------+
//| Convert a char array to a string (overload for char arrays)      |
//+------------------------------------------------------------------+
string StringFromUtf8(const char &utf8[])
{
    uchar temp[];
    int size = ArraySize(utf8);
    ArrayResize(temp, size);
    for (int i = 0; i < size; i++)
    {
        temp[i] = (uchar)utf8[i];
    }
    return CharArrayToString(temp, 0, -1, CP_UTF8);
}
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Convert a string to a char array (overload for char arrays)      |
//+------------------------------------------------------------------+
void StringToUtf8(const string str, char &utf8[], bool ending = true)
{
    ...
    uchar temp[];
    int count = ending ? -1 : StringLen(str);
    StringToCharArray(str, temp, 0, count, CP_UTF8);
    int size = ArraySize(temp);
    ArrayResize(utf8, size);
    for (int i = 0; i < size; i++)
    {
        utf8[i] = (char)temp[i];
    }
